    ...
    <>
      ...
      <div className='p-30 bg-black'>
            ...
            {/*Cards Section*/}
              ...
              <Cards imgName={imgProject1} className="w-[40%] h-[50vh] hover:h-[55vh] transition-all duration-500 ease-in-out" projectName="BugsSmith" textColor={"text-white"}>

                <button className="bg-transparent border-1 border-gray-300 text-white px-3 py-1 rounded-xl text-2 mr-2">ML</button>        

              </Cards>            
              <Cards imgName={imgProject2} className="w-[35%] h-[40vh] hover:h-[65vh] transition-all duration-500 ease-in-out text-black" projectName="Aasan Yatra" textColor={"text-brown-500"}>
              ...
              <Cards imgName={imgProject3} className="w-[35%] h-[40vh] hover:h-[65vh] transition-all duration-500 ease-in-out" projectName="LeavePoint">
              ...
              <Cards imgName={imgProject4} className="w-[40%] h-[50vh] hover:h-[65vh] transition-all duration-500 ease-in-out" projectName="CarbonWise" textColor={"text-white"}>
